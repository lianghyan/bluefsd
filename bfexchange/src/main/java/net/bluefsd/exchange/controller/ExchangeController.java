...
public class ExchangeController extends BaseController {
	...
	public Map addStockExch(@RequestBody Exchange exchange) {
		...
		return composeReturnMap("data", data, "Add stock exchange successfully!", "No change saved!");
	}

	@RequestMapping(value = "/list", method = RequestMethod.POST)
	public Map listExchange() {
		List<Exchange> dataList = exchnageService.listExchange();
		return composeReturnMap("dataList", dataList, "Find exchange successfully!", "No data found!");
	}

	@RequestMapping(value = "/find", method = RequestMethod.POST)
	public Map findExchangeByCd(@RequestParam String exchCd) {
		Exchange data = exchnageService.findExchangeByCd(exchCd);
		return composeReturnMap("data", data, "Find exchange successfully!", "No data found!");
