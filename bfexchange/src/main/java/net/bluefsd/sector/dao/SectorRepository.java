package net.bluefsd.sector.dao;
...
public interface SectorRepository extends JpaRepository<Sector, Long> {
	...
	@Query(value = "SELECT cs FROM Company cs where sectorCd=:sectorCd")
	...
	@Transactional(readOnly = true)
	@Query(value = "SELECT cs.sectorCd, cs.sectorName FROM Sector cs")
